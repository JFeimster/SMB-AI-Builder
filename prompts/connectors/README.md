...
### Repo-to-Deployment Plan

```text
Review this repo or static site plan and create a deployment readiness checklist. Include file structure, routes, sitemap, CSS/JS risks, Vercel considerations, and PR QA steps.
```

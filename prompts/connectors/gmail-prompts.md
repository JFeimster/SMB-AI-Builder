...
Copy and paste these prompts to plan and audit workflows involving Gmail.

## Gmail Workflow Audit

**Use case:** Workflow audit

**Copy/paste prompt:**
> Audit this workflow and recommend the minimum connector stack involving Gmail.
...
## Process Mapping for Gmail

**Use case:** Data mapping

**Copy/paste prompt:**
> Map this process across Gmail and other required tools. Document the data flow.
...
**Copy/paste prompt:**
> Identify the risk classification of using Gmail for this specific workflow. Are there PII or compliance concerns?
...
**Copy/paste prompt:**
> Review this Gmail workflow and identify where human approval is required before the next automation step executes.
...
**Copy/paste prompt:**
> Review these manual Gmail tasks and determine which are the best candidates for automation.
...
**Copy/paste prompt:**
> Create a safe automation pilot plan using only low-risk connectors for this Gmail workflow.
...
**Copy/paste prompt:**
> Generate a comprehensive QA checklist to test the Gmail integration before going live.
...
**Copy/paste prompt:**
> Design a no-auth GPT Action for this Gmail workflow that doesn't expose private data.

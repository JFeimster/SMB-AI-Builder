...
Copy and paste these prompts to plan and audit workflows involving Google Drive.

## Google Drive Workflow Audit

**Use case:** Workflow audit

**Copy/paste prompt:**
> Audit this workflow and recommend the minimum connector stack involving Google Drive.
...
## Process Mapping for Google Drive

**Use case:** Data mapping

**Copy/paste prompt:**
> Map this process across Google Drive and other required tools. Document the data flow.
...
**Copy/paste prompt:**
> Identify the risk classification of using Google Drive for this specific workflow. Are there PII or compliance concerns?
...
**Copy/paste prompt:**
> Review this Drive workflow and identify where human approval is required before the next automation step executes.
...
**Copy/paste prompt:**
> Review these manual Drive tasks and determine which are the best candidates for automation.
...
**Copy/paste prompt:**
> Create a safe automation pilot plan using only low-risk connectors for this Drive workflow.
...
**Copy/paste prompt:**
> Generate a comprehensive QA checklist to test the Google Drive integration before going live.
...
**Copy/paste prompt:**
> Design a no-auth GPT Action for this Drive workflow that doesn't expose private data.
...
## Cross-Platform Data Map

**Use case:** Data mapping

**Copy/paste prompt:**
> Map this process across Gmail, Drive, Calendar, and Notion.

**Inputs needed:** Process description.

**Expected output:** Comprehensive data mapping across the Google Workspace and Notion.

**Human review note:** Check for data duplication.

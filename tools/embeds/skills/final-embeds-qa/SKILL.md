...
- Final step before marking embed tasks complete.

## When not to use this skill
- During initial exploratory work.

## Inputs Jules should collect
- The entire `embeds/` directory and all modified files.
...
## Process
1. Check for expected files and validate HTML/CSS/JS.
2. Verify CTA URLs and referral params.
3. Run final accessibility, responsive, and claims checks.

## Output requirements
- A final QA sign-off.
Include:
- Expected files exist.
- HTML validates enough for static use.
- CSS/JS paths correct.
- CTA URLs correct.
- Referral params safe.

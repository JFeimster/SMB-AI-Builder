# embed-security-safety

## Purpose
Check safety/security of embeds.

## When to use this skill
- Before finalizing any interactive embed code.

## When not to use this skill
- When generating visual assets.

## Inputs Jules should collect
- Code that handles user input or routing.

## Files and folders this skill may touch
- Analyzes JS and HTML files in `embeds/`.
...
## Process
1. Review all URL handlers for open redirects.
2. Ensure no unauthorized credential/data collection.
3. Confirm explicit safety disclaimer visibility.

## Output requirements
- Security and safety compliance validation.
Include:
- No arbitrary redirect destinations.
- No credential collection.
- No private data collection.
- No sensitive workflow submission storage unless explicitly implemented.

# referral-parameter-handler

## Purpose
Handle referral and UTM parameters.

## When to use this skill
- When implementing URL tracking inside embeds.

## When not to use this skill
- When styling UI elements.

## Inputs Jules should collect
- Expected query string structures.

## Files and folders this skill may touch
- Any JS or HTML handling URLs in `embeds/`.
...
## Process
1. Parse incoming URL parameters safely.
2. Encode components.
3. Append safely to outbound CTA links.

## Output requirements
- Secure, tracking-enabled URL handlers.
Requirements:
- Support safe query params:
  - ref
  - utm_source
  - utm_medium
  - utm_campaign
...
- CTA must always point to approved GPT, Notion, or GitHub URLs.
- Do not accept arbitrary destination URLs.

...
## Purpose
Build tiny affiliate/resource cards.

## When to use this skill
- When building the absolute minimum footprint affiliate card.

## When not to use this skill
- When complex interaction or scoring is needed.

## Inputs Jules should collect
- Affiliate headline and bullet points.
...
## Process
1. Build minimal card structure.
2. Add strong headline and 2-3 bullets.
3. Integrate primary CTA with optional ref parameter.

## Output requirements
- A tiny affiliate resource card.
Requirements:
- Minimal card.
- Strong headline.
- 2–3 bullets.
